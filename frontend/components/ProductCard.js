...
function ProductCard({ product }) {
  return (
    <div className="product-card mx-2 bg-light py-3 my-3">
      <img
        src={product.image || "https://parcs.org.au/wp-content/uploads/2016/03/placeholder-image-red-1.png"}
      ...
      <div className="card-body d-flex flex-row justify-content-around mt-4">
        <div className="d-flex flex-column">
          ...
          {product.price && <p className="product-price text-decoration-line-through align-self-bottom">
            {product.price} TL
          </p>}
        </div>
